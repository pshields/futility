...
public class Flag extends StationaryObject {
    ...
    protected PositionEstimate setPosition() {
    	...
    	if (this.id == "(f t l 50)") {
            return new PositionEstimate(-50, -39, 1.0, true);
        }
    	else if (this.id == "(f t l 40)") {
            return new PositionEstimate(-40, -39, 1.0, true);
        }
    	else if (this.id == "(f t l 30)") {
            return new PositionEstimate(-30, -39, 1.0, true);
        }
    	else if (this.id == "(f t l 20)") {
            return new PositionEstimate(-20, -39, 1.0, true);
        }
    	else if (this.id == "(f t l 10)") {
            return new PositionEstimate(-10, -39, 1.0, true);
        }
    	else if (this.id == "(f t 0)") {
            return new PositionEstimate(0, -39, 1.0, true);
        }
            ...
            return new PositionEstimate(57.5, -30, 1.0, true);
        }
    	else if (this.id == "(f r t 20)") {
            return new PositionEstimate(57.5, -20, 1.0, true);
        }
    	else if (this.id == "(f r t 10)") {
            return new PositionEstimate(57.5, -10, 1.0, true);
        }
    	else if (this.id == "(f r 0)") {
            return new PositionEstimate(57.5, 0, 1.0, true);
        }
            ...
            return new PositionEstimate(-52.5, -34, 1.0, true);
        }
            ...
            return new PositionEstimate(0, -34, 1.0, true);
        }
    	else if (this.id == "(f c)") {
            return new PositionEstimate(0, 0, 1.0, true);
        }
    	else if (this.id == "(f c b)") {
            return new PositionEstimate(0, 34, 1.0, true);
        }
    	else if (this.id == "(f p l t)") {
            return new PositionEstimate(-36, -20.15, 1.0, true);
        }
    	else if (this.id == "(f p l c)") {
            return new PositionEstimate(-36, 0, 1.0, true);
        }
            ...
            return new PositionEstimate(-52.5, -7.01, 1.0, true);
        }
